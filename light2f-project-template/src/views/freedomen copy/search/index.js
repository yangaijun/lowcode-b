...
function Search(props) {
    var className = (0, react_1.useMemo)(function () {
        var searchClassName = '__freedomen-search';
        if (props.className) {
            searchClassName += (" " + props.className);
        }
        return searchClassName;
    }, [props.className]);
    return react_1.default.createElement(form_1.default, __assign({ config: { layout: 'inline', labelCol: undefined } }, props, { className: className }));
}
