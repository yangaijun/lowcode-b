...
function FTag(props) {
    ...
    var color = (0, useBase_1.useAddCallbackValue)(props, config.color);
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Tag, __assign({ className: className, style: style }, config, { color: color }), filter);
    }, [className, style, config, filter]);
}
exports.default = FTag;
