...
function FDateRange(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(RangePicker, __assign({ picker: dType, showTime: type === 'rangedate-datetime', style: style, value: innerValue, placeholder: item.placeholder, className: className, disabled: disabled }, config, { onChange: function (value) {
                onChange(parseValue(value));
            } }));
    }, [onChange, item.placeholder, style, className, disabled, config, type, dType, innerValue]);
}
exports.default = FDateRange;
