...
function FMentions(props) {
    ...
    var mentionOptions = (0, react_1.useMemo)(function () {
        return options.map(function (option, i) {
            return __assign({ value: option[valuename], label: option.option || option[labelname], style: itemStyles[i] }, option);
        });
    }, [options, itemStyles, valuename, labelname]);
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Mentions, __assign({ style: style, options: mentionOptions, className: className, loading: loading, placeholder: item.placeholder, disabled: disabled, value: item.value, onChange: onChange }, ridKeysConfig));
    }, [style, item.value, mentionOptions, item.placeholder, onChange, disabled, className, ridKeysConfig]);
}
exports.default = FMentions;
