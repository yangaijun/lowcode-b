...
function FTree(props) {
    ...
    var rst = (0, react_1.useMemo)(function () {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Tree, __assign({ style: style, className: className, dropdownRender: dropdownRender, disabled: disabled, treeData: options }, rst, ridKeysConfig, { fieldNames: fieldNames }));
    }, [style, dropdownRender, className, disabled, options, rst, ridKeysConfig]);
}
exports.default = FTree;
