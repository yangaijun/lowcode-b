...
function FAvatar(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Avatar, __assign({ src: filter, className: className, style: style }, config));
    }, [filter, className, style, config]);
}
exports.default = FAvatar;
