...
function FInputNumber(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.InputNumber, __assign({ disabled: disabled, className: className, style: style, value: item.value, onChange: onChange }, config));
    }, [disabled, className, style, item.value, onChange, config]);
}
exports.default = FInputNumber;
