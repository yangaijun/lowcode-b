...
function FSpace(props) {
    ...
    var sType = types[type] || types.space;
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Space, __assign({ style: style, direction: sType, className: className }, config), children);
    }, [style, sType, className, config, children]);
}
exports.default = FSpace;
