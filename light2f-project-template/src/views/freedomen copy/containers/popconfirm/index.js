...
function FPopconfirm(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Popconfirm, __assign({ title: filter, style: style, className: className, onConfirm: function (_) { return onEvent("confirm", value); }, onCancel: function (_) { return onEvent("cancel", value); } }, config), children);
    }, [value, style, filter, className, config, onEvent, children]);
}
exports.default = FPopconfirm;
