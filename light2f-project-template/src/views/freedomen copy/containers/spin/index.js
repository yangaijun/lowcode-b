...
function FSpin(props) {
    ...
    return (0, react_1.useMemo)(function () {
        return react_1.default.createElement(antd_1.Spin, __assign({ style: style, spinning: value, className: className }, config), children);
    }, [style, className, config, value, children]);
}
exports.default = FSpin;
